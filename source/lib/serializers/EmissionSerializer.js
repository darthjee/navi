...
class EmissionSerializer extends Serializer {
   ...
   * @returns {{ id: number, status: string, url: string, method: string, httpStatus: (number|null), error: (string|null), itemRef: (string|null), timestamp: string }} Plain object representation of the emission record.
   */
