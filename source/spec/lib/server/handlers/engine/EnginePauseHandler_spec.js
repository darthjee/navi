...
import { EnginePauseHandler } from '../../../../../lib/server/handlers/engine/EnginePauseHandler.js';
import { Application } from '../../../../../lib/services/Application.js';

describe("describe('EnginePauseHandler'", () => {
  let res;
  ...
  it('is an instance of RequestHandlerExecutor', () => {
    expect(new EnginePauseHandler({}, res)).toBeInstanceOf(RequestHandler);
  });
  ...
  describe('#handle', () => {
    describe('when engine is running', () => {
      ...
      it('calls Application.pause()', async () => {
        await new EnginePauseHandler({}, res).handle();
    ...
    describe('when engine is not running', () => {
      ...
      it('throws a ConflictError', async () => {
        await expectAsync(new EnginePauseHandler({}, res).handle())
