...
describe("describe('EngineContinueHandler'", () => {
  ...
  it('is an instance of RequestHandlerExecutor', () => {
    expect(new EngineContinueHandler({}, res)).toBeInstanceOf(RequestHandler);
  });
  ...
  describe('#handle', () => {
    describe('when engine is paused', () => {
      ...
      it('calls Application.continue()', async () => {
        await new EngineContinueHandler({}, res).handle();
    ...
    describe('when engine is not paused', () => {
      ...
      it('throws a ConflictError', async () => {
        await expectAsync(new EngineContinueHandler({}, res).handle())
