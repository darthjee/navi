...
| File | Contents |
|------|----------|
| [Overview](docs/agents/overview.md) | General application idea, full startup sequence, job-state diagram, resource-chaining cycle, web interface, and implementation checklist (done vs. planned). |
...
| [Runtime Flow](docs/agents/flow.md) | CLI entrypoint, config loading, initial enqueueing, Engine loop, worker execution, failure handling, web UI routes. |
