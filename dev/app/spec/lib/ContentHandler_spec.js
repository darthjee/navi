...
describe('ContentHandler', () => {
  ...
  describe('#handle — without a serializer', () => {
    const app = buildContentHandlerApp('/categories/:id/items/:item_id.json', data);
  ...
  describe('#handle — with a custom extractorFactory', () => {
    ...
    const app = buildContentHandlerApp('/any/:x.json', data, defaultSerializer, factory);
  ...
  describe('#handle — with a serializer', () => {
    const app = buildContentHandlerApp('/categories/:id.json', data, defaultSerializer);
