...
describe('ContentHandlerExecutor', () => {
  ...
  describe('#handle — with a custom extractorFactory', () => {
    ...
    const app = buildContentExecutorApp('/any/:x.json', data, defaultSerializer, factory);
  ...
  describe('#handle — with a serializer', () => {
    const app = buildContentExecutorApp('/categories/:id.json', data, defaultSerializer);
