...
class JobFactory extends Factory {
   ...
   * @param {class} options.klass - The class to instantiate (default is the generic `Job` base class).
   ...
   */
  constructor({ klass = Job, attributesGenerator = new IdGenerator(), attributes = {} } = {}) {
   ...
   * @param {object} params - The parameters for building a Job instance, forwarded to `klass`'s constructor.
   ...
   * @param {class} [attributes.klass] - The class to instantiate (default is the generic `Job` base class).
