...
**Current Version:** [1.11.0](https://github.com/darthjee/navi/releases/tag/1.11.0)

**Next Release:** [1.11.1](https://github.com/darthjee/navi/compare/1.11.0...main)
...
See the [configuration schema](docs/guides/navi/configuration-schema.md) for the full field-by-field reference.
...
See the [Configuration File Fields](docs/guides/navi/configuration-schema.md#fields) table for the full field-by-field breakdown of `parser` and `emit`.
